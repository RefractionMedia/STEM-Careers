...
namespace STEM_Careers.Views
{
    ...
    public partial class PeoplePickPage : ContentPage
    {
        private STEMPickerViewModel vm;

        public PeoplePickPage(STEMPickerViewModel vm )
        {
            InitializeComponent();
            if (vm == null)
        ...
        private async Task FindPath(object sender, System.EventArgs e)
        {
            ...
            MessagingCenter.Send<PeoplePickPage, string>(this, "STEMPickers", concat);
        }
    }
}